...
const { Monitor, TrendingUp, Users, Eye, Clock, Zap, MapPin, Smartphone, Tablet, RefreshCw } = Lucide as any;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Anal&iacute;ticas Web</h2>
          <p className="text-muted-foreground">Monitorea el rendimiento y las visitas de tu tienda en tiempo real</p>
        </div>
