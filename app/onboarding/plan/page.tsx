...
export default function OnboardingPlanPage() {
    ...
    useEffect(() => {
        if (!companyLoading && company?.id && (company.company_plan_status === 'active' || company.company_plan_status === 'trialing' || company.company_plan_status === 'trial' || company.plan_is_active === true)) {
