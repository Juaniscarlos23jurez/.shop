  ...
  return (
    <section id="contact" className="py-16 bg-white" >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isEurope ? (
          <div className="py-20 px-4 text-center space-y-6 bg-slate-50 rounded-[2.5rem] border border-dashed border-slate-200 max-w-4xl mx-auto">
            <div className="w-20 h-20 bg-amber-100 text-amber-600 rounded-full flex items-center justify-center mx-auto mb-6 text-3xl">
              🌍
            </div>
            <h3 className="text-3xl font-black text-slate-900 tracking-tight">Servicio no disponible en tu región</h3>
            <p className="text-slate-500 text-lg max-w-md mx-auto leading-relaxed">
              Lamentamos informarte que la activación de Apps y servicios de consultoría personalizada de Fynlink+
              aún no está disponible para el territorio europeo. Estamos trabajando para expandirnos pronto.
            </p>
          </div>
        ) : (
