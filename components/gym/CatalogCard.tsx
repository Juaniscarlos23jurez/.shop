    ...
    <>
      ...
      >
        <div className="flex flex-row h-full">
          <div className="relative w-44 sm:w-64 md:w-80 flex-shrink-0 bg-zinc-950 flex flex-col items-stretch overflow-hidden">
          ...
          <div className="fixed inset-x-0 bottom-0 z-50 animate-in slide-in-from-bottom duration-500 pb-safe">
            <div className="bg-zinc-900 rounded-t-[2.5rem] shadow-[0_-20px_50px_rgba(0,0,0,0.5)] max-h-[92vh] overflow-hidden flex flex-col border-t border-zinc-800">
              ...
              <div className="overflow-y-auto px-6 pb-10">
                ...
                {item.image_url ? (
                  <div className="w-full flex items-center justify-center bg-zinc-950 rounded-[2rem] mb-8 border border-zinc-800 shadow-inner group-modal overflow-hidden">
                    <img
                      src={item.image_url}
                      alt={item.name}
